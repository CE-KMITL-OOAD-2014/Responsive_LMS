...
<div class="line_col12 col-sm-12"></div>
    <div class="col-lg-12 text-center">
      <button class="btn btn-success" onClick="location.href='{{ url('/teacher/add_message') }}'"><span class="glyphicon glyphicon-book"></span> ส่งข้อความ</button>
    </div>
<div class="line_col12 col-sm-12"></div>
...
<script type="text/javascript">
  ...
  function search_data() {
        ...
        updateValElement();
        $.get('{{ url("teacher/search_message/search") }}',{condition:condition ,currentPage:currentPage },function(data){
  ...
  function updateValElement(){
   //condition={read:'1',unread:'1'};
    condition={read:$('#show_data_01').prop("checked")?'1':'0',unread:$('#show_data_02').prop("checked")?'1':'0'};
      ...
      $.get('{{ url("teacher/search_message/get_count") }}',{condition:condition},function(data){
           count_mem=data;
