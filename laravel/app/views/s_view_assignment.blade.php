  ...
  <div class="container">
	...
	<div class="line_col12 col-sm-12"></div>
	 <div class="col-lg-12 text-center">
	  <button type="button" class="btn btn-primary" onclick="location.href='{{url('/student/s_assignment')}}'"><span class="glyphicon glyphicon-circle-arrow-left" ></span> ย้อนกลับไปหน้าก่อนหน้า</button>
	  <button type="button" class="btn btn-success" onclick="location.href='{{url('student/view_add_submit_assignment/'.$ass->getID() )}}'"><span class="glyphicon glyphicon-send " ></span> ส่งงาน</button>
     </div>
	<div class="line_col12 col-sm-12"></div>
    </form>
  </div>
