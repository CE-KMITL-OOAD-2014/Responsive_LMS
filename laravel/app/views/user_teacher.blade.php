...
<div class="line_col12 col-sm-12"></div>
    <div class="col-lg-12 text-center">
      <button class="btn btn-success" onClick="location.href='{{url('admin/add_user_teacher')}}'"><span class="glyphicon glyphicon-plus"></span> เพิ่มผู้ใช้งาน</button>
    </div>
<div class="line_col12 col-sm-12"></div>
...
<script type="text/javascript">
  ...
  function search_data() {
        updateValElement();
        $.get('{{ url("search_teacher/search") }}',{condition:condition ,currentPage:currentPage },function(data){
