...
<div class="line_col12 col-sm-12"></div>
    <div class="col-lg-12 text-center">
      <button class="btn btn-success" onClick="location.href='{{url('admin/add_user_student')}}';"><span class="glyphicon glyphicon-plus"></span> เพิ่มผู้ใช้งาน</button>
    </div>
<div class="line_col12 col-sm-12"></div>
...
<script type="text/javascript">
  ...
  function search_data() {
        updateValElement();
        $.get('{{ url("search_student/search") }}',{condition:condition ,currentPage:currentPage },function(data){
  ...
  function updateValElement(){
      ...
      $.get('{{ url("search_student/get_lastpage") }}',{condition:condition},function(data){
          ...
          $('#page_display_1,#page_display_2').html('หน้าที่ '+currentPage+' / '+data);
       });
